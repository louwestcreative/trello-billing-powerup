...
t.initialize({
  'card-back-section': function(t, opts) {
    return {
      ...
      content: {
        type: 'iframe',
        url: t.signUrl('https://louwestcreative.github.io/trello-billing-powerup/index.html'),
        height: 300
      }
    };
  },
    ...
    return [
      {
        ...
        callback: function(t) {
          return t.modal({
            url: 'https://louwestcreative.github.io/trello-billing-powerup/modal.html?type=charge',
            title: 'Add Charge',
            height: 320,
            fullscreen: false
          });
      ...
      },
      {
        ...
        callback: function(t) {
          return t.modal({
            url: 'https://louwestcreative.github.io/trello-billing-powerup/modal.html?type=payment',
            title: 'Add Payment',
            height: 320,
            fullscreen: false
          });
  ...
  'board-buttons': function(t, opts) {
    return [{
      ...
      callback: function(t) {
        return t.modal({
          url: 'https://louwestcreative.github.io/trello-billing-powerup/board-summary.html',
